...
void GPIO_config_input_nopull(volatile uint8_t *reg_name, uint8_t pin_num); /* GPIO_config_input_nopull */

void GPIO_config_input_pullup(volatile uint8_t *reg_name, uint8_t pin_num);

void GPIO_write_low(volatile uint8_t *reg_name, uint8_t pin_num);

void GPIO_write_high(volatile uint8_t *reg_name, uint8_t pin_num); /* GPIO_write_high */

void GPIO_toggle(volatile uint8_t *reg_name, uint8_t pin_num); /* GPIO_toggle */

uint8_t GPIO_write_read(volatile uint8_t *reg_name, uint8_t pin_num);
